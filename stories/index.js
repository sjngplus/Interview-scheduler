...
//Appointment(From index.jsx) stories
storiesOf("Appointment", module)
  ...
  .add("Edit Form", () => <Form name="Student McFry" interviewers={interviewers} interviewer={2} onSave={action("onSave")} onCancel={action("onCancel")}/>)
